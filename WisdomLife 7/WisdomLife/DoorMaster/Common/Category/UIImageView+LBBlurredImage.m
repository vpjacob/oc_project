...
NSString *const kDMLBBlurredImageErrorDomain          = @"com.lucabernardi.blurred_image_additions";
CGFloat const   kDMLBBlurredImageDefaultBlurRadius    = 20.0;
...
- (NSError *)errorForNotExistingFilterWithName:(NSString *)filterName
{
    ...
    NSError *error             = [NSError errorWithDomain:kDMLBBlurredImageErrorDomain
