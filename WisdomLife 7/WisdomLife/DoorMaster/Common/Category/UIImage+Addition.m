...
CGFloat DMDegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat DMRadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};
...
{
    return [self imageRotatedByDegrees:DMRadiansToDegrees(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(DMDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, DMDegreesToRadians(degrees));
...
+ (UIImage *)streImageName:(NSString *)imageName
{
    if (imageName == nil) {
        return nil;
    }
    UIImage *image = [UIImage imageNamed:imageName];
    UIImage *strImage = [image stretchableImageWithLeftCapWidth:image.size.width/2 topCapHeight:image.size.height/2];
    return strImage;
}
