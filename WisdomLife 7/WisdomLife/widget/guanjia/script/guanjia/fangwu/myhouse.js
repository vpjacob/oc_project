				...
				if (result.state == 1) {
					if (data.length == undefined || data.length == 0 || data == undefined || data == '' || data.length == '') {
						...
						for (var i = 0; i < data.length; i++) {
							...
							nowli += '<div class="same">' + '<div class="sameBox slide">' + '<div class="top">' + '<span>' + data[i].ownerName + '</span>' + '<span>' + data[i].ownerPhone + '</span>' + '</div>' + '<div class="mid">' + '<span>' + test + '</span>' + '</div>' + '<div class="last">' + '<div class="last_left biandel">' + '<a class="compile" value="' + data[i].roomId + '"><img src="../../../image/tempcheng.png" alt=""/>' + '<span >租户申请</span></a>' + '</div>' + '<div class="last_right">' + '<a class="change" value="' + data[i].roomId + '"><img src="../../../image/bianji.png" alt=""/>' + '<span>编辑</span></a>' + '<a class="family" value="' + data[i].id + '" data="' + data[i].roomId + '"><img src="../../../image/chengy.png" alt=""/>' + '<span >家庭成员</span></a>' + '</div>' + '</div>' + '</div>' + '<span class="delInfo" value="' + data[i].id + '">删除</span>' + '</div>'
						}
						$('#showList').html(nowli);
						//租户审核
